...
Данная прогармма способна, в зависимости от текущих требований, использовать  **TCP** либо **HTTP** ( если вынуждены
...
Полученый результат кодогенерации на сервере, **AdHocAgent** выгрузит **в текущую рабочую директорию** своего процесса
...
И рядом с файлом спецификации появился бэкап предидущей версии спецификации.
